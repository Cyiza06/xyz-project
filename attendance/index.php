    ...
    <div class="main">
        ...
        <main>
            <div class="main-buttons">
                ...
                <a href="./addAtt.php" class="button-primary">
                    Make Attendance
                </a>
            </div>
            <div class="main-content">
                <?php
                    $query = "SELECT * FROM attendance INNER JOIN employee ON attendance.EmployeeId = employee.EmployeeId ORDER BY Date DESC";
                    $result = mysqli_query($conn, $query);
                        ...
                        echo "<table>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>
                                            ...
                                            <td>" . ($row['CheckOutTime'] == NULL ? "<a href=\"updateout.php?id=" . $row['EmployeeId'] . "\">Add time</a>" : $row['CheckOutTime']) . "</td>
                                            <td>" . $row['Department'] . "</td>
                                            <td>" . $row['Status'] . "</td>
                                            <td>
                                                <a href='update_employee.php?id=" . $row['EmployeeId'] . "'>Update</a> |
                                                <a href='?delete_id=" . $row['EmployeeId'] . "' onclick='return confirm(\"Are you sure you want to delete this Attendance?\")'>Delete</a>
                                            </td>
                                        </tr>";
                                    $count++;
                                }
